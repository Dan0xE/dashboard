...
export const Home = () => {
  ...
  return (
    <div className="relative w-screen h-screen">
      <Clock />
      <div className="flex items-center justify-center bottom-0 h-12 w-12 rounded-full shadow-2xl ml-10 bg-gray-700 absolute z-20 mb-10 hover:-translate-y-1 ease-linear duration-100">
        {/* //@ts-ignore */}
